        ...
        <div class="sidebar__cat-list">
            <ul class="list-wrap">
                ...
                foreach ($result_category as $row_category) 
                {
                                                    ?>
                <li>
                    <a href="<?= base_url("{$row_category->category_slug}"); ?>"><i class="flaticon-arrow-button"></i><?=$row_category->category_name;?></a>
                </li>
                <?php
                                                } ?>
                <!-- <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Wardrobe Handle</a>
                </li>
                <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Main Door Handle</a>
                </li>
                <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Glass Door Handle</a>
                </li>
                <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Mortise Handle</a>
                </li>
                <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Drawer Knob</a>
                </li>
                <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Drawer Kadi</a>
                </li>
                <li>
                    <a href="#"><i class="flaticon-arrow-button"></i>Sofa Leg</a>
                </li> -->
            </ul>
        </div>
    </div>
 <div class="sidebar__widget">
                                    <h4 class="sidebar__widget-title">Ask For Quote 
